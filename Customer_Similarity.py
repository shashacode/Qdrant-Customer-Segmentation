...
# Assuming results_df already contains the 'Cluster' column
...
# Step 4: Optionally, save the cluster results in a DataFrame for further analysis
# segmentation_data = [
#     {
#         "Customer ID": result.payload['customer_id'],
#         "Age": result.payload['age'],
...
#         "Cluster": label
#     }
#     for result, label in zip(reranked_results, cluster_labels)
# ]
